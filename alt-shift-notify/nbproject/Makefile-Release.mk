...
${OBJECTDIR}/KeyScanner.o: KeyScanner.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KeyScanner.o KeyScanner.cpp

${OBJECTDIR}/SubscriberList.o: SubscriberList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubscriberList.o SubscriberList.cpp

${OBJECTDIR}/UDevContext.o: UDevContext.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UDevContext.o UDevContext.cpp

${OBJECTDIR}/UDevDevice.o: UDevDevice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UDevDevice.o UDevDevice.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/process-tag.o: process-tag.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libudev`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/process-tag.o process-tag.cpp
